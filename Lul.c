...
#define DATA 0    	// yellow
#define LATCH 1   	// green
#define CLOCK 2   	// grey
...
void lim(){
  ...
  if(NUMERO1 == -1){
    ...
    if(OPERADOR != 4 ){
      if(OPERADOR == 2 || (NUMERO1 - NUMERO2) == 0 ){
      	lcd.setCursor(11,1);
        lcd.print("0");
...
void loop() 
{
  ...
  if (digitalRead(pulsador1) == 0 && NUMERO1 < 9){
  delay(10);
  NUMERO1++;
  lcd.setCursor(2,1);
  lcd.print(NUMERO1);
  ...
  }else if(digitalRead(pulsador1) == 0 && NUMERO1 == 9){
  	delay(10);
    NUMERO1 = 0;
    lcd.setCursor(2,1);
    lcd.print(NUMERO1);
...
if (digitalRead(OPBA) == 0 && NUMERO1 != -1){
  delay(10);
  OPERADOR++;
  if(RESULTADO >= 10 || RESULTADO < 0){
   	lim();
...
if (digitalRead(pulsador2) == 0 && NUMERO2 < 9 && NUMERO1 != 0 && OPERADOR != 0){
  delay(10);
  NUMERO2++;
  lcd.setCursor(6,1);
  lcd.print(NUMERO2); 
...
}else if (digitalRead(pulsador2) == 0 && NUMERO2 == 9 && NUMERO1 != -1 && OPERADOR != 0){
  delay(10);
  NUMERO2 = 0;
  lcd.setCursor(6,1);
  lcd.print(NUMERO2);
 ...
 if (NUMERO1 != -1 && OPERADOR != 0 && NUMERO2 != -1){
  //delay(100);
  lcd.setCursor(9,1);
  lcd.print("=");
